...
for path in tqdm(Path('/home/sake/MusicGenRepEng_Dataset_separated').rglob('*.mp3')):
    ...
    out_path = str(path).replace('MusicGenRepEng_Dataset_separated', 'MusicGenRepEng_Dataset_hidden_states_30-60_mid10')
    ...
    torch.save(rep_vec.cpu(), str(path.with_suffix('.pt')).replace('MusicGenRepEng_Dataset_separated', 'MusicGenRepEng_Dataset_hidden_states_30-60_mid10'))