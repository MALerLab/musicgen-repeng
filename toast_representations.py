...
for path in tqdm(Path('/home/sake/MusicGenRepEng_Dataset_separated').rglob('*.mp3')):
    ...
    out_path = str(path).replace('MusicGenRepEng_Dataset_separated', 'MusicGenRepEng_Dataset_50ms_energetic_sleepy_mediummodel_rock')
    ...
    torch.save(hidden_states, str(path.with_suffix('.pt')).replace('MusicGenRepEng_Dataset_separated', 'MusicGenRepEng_Dataset_50ms_energetic_sleepy_mediummodel_rock'))
